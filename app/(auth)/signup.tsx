...
const flavorImages = {
    blueberryBobo: require('../../assets/product_images/Blueberry-Bobo-Tea-500u.webp'),
    blueberryMilkshake: require('../../assets/product_images/Blueberry-Milkshake-500u.webp'),
    boboMilkTea: require('../../assets/product_images/Bobo-Milk-Tea-500u.webp'),
    chocolateIceCream: require('../../assets/product_images/Chocolate-Ice-Cream.webp'),
    grapeBobTea: require('../../assets/product_images/Grape-Bobo-Tea-700ml.webp'),
    BlueberrySundae: require('../../assets/product_images/Blueberry-Sundae-360.webp'),
